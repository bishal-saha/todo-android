...
public class EditTaskFragmentDirections {
  private EditTaskFragmentDirections() {
  }

  @NonNull
  public static ActionEditTaskFragmentToTaskDetailFragment actionEditTaskFragmentToTaskDetailFragment(
    ...
    return new ActionEditTaskFragmentToTaskDetailFragment(dateTime, title, body, status, userId, statusColor, id);
  }

  @NonNull
  public static NavDirections actionEditTaskFragmentToNavigationHome() {
    return new ActionOnlyNavDirections(R.id.action_editTaskFragment_to_navigation_home);
  }

  public static class ActionEditTaskFragmentToTaskDetailFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionEditTaskFragmentToTaskDetailFragment(@NonNull String dateTime,
    ...
    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setDateTime(@NonNull String dateTime) {
      if (dateTime == null) {
        throw new IllegalArgumentException("Argument \"date_time\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("date_time", dateTime);
    ...
    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setTitle(@NonNull String title) {
      if (title == null) {
        throw new IllegalArgumentException("Argument \"title\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("title", title);
    ...
    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setBody(@NonNull String body) {
      if (body == null) {
        throw new IllegalArgumentException("Argument \"body\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("body", body);
    ...
    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setStatus(@NonNull String status) {
      if (status == null) {
        throw new IllegalArgumentException("Argument \"status\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("status", status);
    ...
    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setUserId(@NonNull String userId) {
      if (userId == null) {
        throw new IllegalArgumentException("Argument \"user_id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("user_id", userId);
    ...
    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setStatusColor(@Nullable String statusColor) {
      this.arguments.put("status_color", statusColor);
      return this;
    }

    @NonNull
    public ActionEditTaskFragmentToTaskDetailFragment setId(@NonNull String id) {
      if (id == null) {
        throw new IllegalArgumentException("Argument \"id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("id", id);
    ...
    public int getActionId() {
      return R.id.action_editTaskFragment_to_taskDetailFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionEditTaskFragmentToTaskDetailFragment that = (ActionEditTaskFragmentToTaskDetailFragment) object;
    ...
    public String toString() {
      return "ActionEditTaskFragmentToTaskDetailFragment(actionId=" + getActionId() + "){"
